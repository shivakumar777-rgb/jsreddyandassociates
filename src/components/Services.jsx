...
const services = [
  {
    id: "direct-tax",
    icon: (<svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2z" /></svg>),
    title: "Direct Tax",
  ...
  {
    id: "gst",
    icon: (<svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2z" /></svg>),
    ...
    <section className="py-20 bg-white" id="services">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <p className="text-yellow-700 font-body font-semibold text-sm tracking-widest uppercase mb-3">What We Do</p>
          <h2 className="text-4xl sm:text-5xl font-display font-bold text-gray-900 mb-4">Our Core Services</h2>
          <div className="section-divider mx-auto mb-6" />
          <p className="text-gray-500 font-body max-w-2xl mx-auto text-lg">
            Comprehensive financial and legal services tailored for corporates, SMEs, startups, NRIs, and individuals.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service) => (
            <div key={service.id}
              ...
              <div className="service-icon mb-5" style={{ color: "#c9a84c" }}>{service.icon}</div>
              <h3 className="font-display font-semibold text-gray-900 text-lg mb-3 group-hover:text-yellow-800 transition-colors">
                {service.title}
              </h3>
              <p className="text-gray-500 text-sm font-body leading-relaxed">{service.desc}</p>
