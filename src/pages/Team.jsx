...
const partners = [
  ...
  },
  {
    ...
    bio: "Priya leads the GST and indirect taxation practice. She has extensive experience in GST implementation, audits, refunds and representation before GST authorities. Previously with a Big 4 firm.",
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-300 font-body text-lg max-w-2xl">
            A qualified team of FCAs and associates with expertise spanning
            taxation, audit, corporate laws and international finance.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            {partners.map((p, i) => (
              <div
                key={p.name}
                className="card-lift rounded-2xl overflow-hidden border border-gray-100 grid lg:grid-cols-3"
              >
                <div
                  className={`bg-gradient-to-br ${p.color} p-10 flex flex-col items-center justify-center text-white text-center ${
                    i % 2 === 1 ? "lg:order-last" : ""
                  }`}
                >
                  ...
                  <div className="flex gap-2 mt-3 flex-wrap justify-center">
                    <span className="px-3 py-1 rounded-full bg-white/20 text-xs font-body">
                      {p.qual}
                    </span>
                    <span className="px-3 py-1 rounded-full bg-white/20 text-xs font-body">
                      {p.exp}
                ...
                <div className="p-8 lg:col-span-2 flex flex-col justify-center">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 font-body text-sm mb-3">
                      Areas of Expertise:
                    </p>
                    <div className="flex flex-wrap gap-2">
                      {p.areas.map((a) => (
                        <span
                          key={a}
                          className="px-3 py-1 text-sm rounded-full border border-yellow-300 text-yellow-800 bg-yellow-50 font-body"
                        >
                          {a}
                        </span>
                      ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {associates.map((a) => (
              <div
                key={a.name}
                className="card-lift bg-white rounded-xl p-5 border border-gray-100 text-center"
              >
                <div
                  className="w-14 h-14 rounded-full mx-auto mb-3 flex items-center justify-center text-white font-bold font-display text-lg"
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <p className="text-gray-300 font-body leading-relaxed mb-6">
                  Together our team holds qualifications including FCA, CMA,
                  DISA, FAFD, GST Certification, CCA, Insolvency Professional
                  and CS. We collaborate with IT professionals, lawyers,
                  chartered engineers, and ex-bankers.
                </p>
              ...
              <div className="flex flex-wrap gap-3">
                {["FCA","CMA","DISA","FAFD","GST Expert","CS","Insolvency Professional","CCA","CISA","MBA Finance"].map((q) => (
                  <span
                    key={q}
                    className="px-4 py-2 rounded-full border border-yellow-500/40 text-yellow-300 text-sm font-body bg-yellow-500/10"
                  >
                    {q}
                  </span>
                ))}
      ...
      >
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-300 font-body mb-8">
            We're always looking for talented CA professionals. If you're
            passionate about excellence in finance, we'd love to hear from you.
          </p>
